...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>Harker Contracting, LLC</title>
        <meta property="og:title" content="Harker Contracting, LLC" />
        <meta
          property="og:image"
      ...
      <header data-thq="thq-navbar" className="home-navbar-interactive">
        <Link to="/">
          <img
            alt="logo"
            src="/playground_assets/hcl-logowhite-text-transparent-background%20resized%20for%20ms365-1500h.png"
            className="home-logo"
          />
        </Link>
        <div
          ...
          >
            <div className="home-container01">
              <Link to="/" className="home-navlink1">
                <img
                  alt="image"
                  src="/playground_assets/hcl-logored-text-transparent-background-200h.png"
            ...
            >
              ...
              <span className="home-text07">Contact</span>
            </nav>
          </div>
        </div>
      </header>
      ...
      <div className="home-hero">
        <div className="home-container02">
          <div className="home-container03">
            <Player
              src="https://assets7.lottiefiles.com/private_files/lf30_vnbcd4ev.json"
              loop
              speed="1"
              autoplay
            ...
            <span className="home-text09">
              Welcome to our website! We are currently working hard to bring you
              an exceptional online experience. Stay tuned for updates and
        ...
        <div className="home-container04">
          <div className="home-container05">
            <div className="home-container06">
              <h6 className="home-text10">in the meantime</h6>
              <h3 className="home-text11 Healine">
                Check out our sister company, Polished Prose.
              </h3>
              <div className="home-container07">
                <Player
                  src="https://assets7.lottiefiles.com/packages/lf20_yswp4uj3.json"
                  loop
                  speed="1"
                  autoplay
                  background="transparent"
                ...
                <span className="home-text12">
                  Polished Prose is a service that can help you create your best
                  work. We offer a range of quality writing and editing services
                  to ensure that you are satisfied with the final product. Our
                  goal is to exceed your expectations and leave you with a
                  smile. 🙂
                </span>
              </div>
            </div>
            <a
              href="https://www.polishedprose.net"
              target="_blank"
              rel="noreferrer noopener"
              className="home-link button"
            >
              TAKE YOUR WRITING TO THE NEXT LEVEL WITH POLISHED PROSE
            </a>
            <div className="home-cards-container">
              <div className="home-card1">
                ...
                <h6 className="home-text13 TextXL">Awarded Agency</h6>
              ...
              <div className="home-card2">
                ...
                <h6 className="home-text15 TextXL">Free Revisions</h6>
              ...
              <div className="home-card3">
                ...
                <h6 className="home-text17 TextXL">Verified Company</h6>
            ...
            <div className="home-work-with-us">
              <div className="home-container11">
                ...
                <h3 className="home-text19 Healine">
                ...
                <span className="home-text25">Check Notus PRO React!</span>
              </div>
              <div className="home-container13">
                ...
                <div className="home-container15">
                  <h4 className="home-text26 Healine">
                    <span className="home-text27">Top Notch Services</span>
                    <br></br>
                  </h4>
        ...
        <div className="home-growing-company-section">
          ...
          <div className="home-container16">
            <div className="home-container17">
              <svg viewBox="0 0 967.4605714285714 1024" className="home-icon12">
